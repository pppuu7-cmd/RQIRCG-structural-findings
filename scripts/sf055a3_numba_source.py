...
Execution backend copied without scientific changes from the historical SF055A3
baseline branch. It computes the same full-mask coefficient as
sf055a2_source_fourier_seed_engine.eh_vertex_fourier.
"""
import math
import numpy as np
